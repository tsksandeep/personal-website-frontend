          ...
          <div className="col-md-6 col-lg-6">
            <div className="project-card-wrapper">
              <div className="project-card-no-image">
                ...
                <h4>
                  This project enables users to save torrent file contents (with
                  a maximum size of 5 GB) directly to the cloud and download
                  them quickly without worrying about seeds. <br /> <br /> Tech
                  Stack: React, Go, Python, DynamoDB, RDS PostgreSQL
                </h4>
            ...
            <div className="project-card-wrapper">
              <div className="project-card-no-image">
                ...
                <h4>
                  ...
                  multiple languages in theatres using augmented reality. As of
                  now, the audience can use android phones to experience it.{" "}
                  <br /> <br /> Tech Stack: Go, C#, gRPC, Sqlite3
                </h4>
                <div className="project-creators">
                  <img
                    className="rounded-circle project-creator-circle"
            ...
            <div className="project-card-wrapper">
              <div className="project-card-no-image">
                ...
                <h4>
                  ...
                  security. <br /> <br /> Tech Stack: React, Django, PostgreSQL
                </h4>
                <div className="project-creators">
                  <img
                    className="rounded-circle project-creator-circle"
