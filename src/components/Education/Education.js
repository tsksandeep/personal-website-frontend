                ...
                <div className="education group">
                    ...
                    <div className="item">
                        <div className="row">
                            ...
                            <div className="col-6 custom-period"><span className="period">2016 - 2020</span></div>
                        </div>
                    ...
                    <div className="item">
                        <div className="row">
                            ...
                            <div className="col-md-6 custom-period"><span className="period">2003 - 2016</span></div>
                        </div>
